...
import com.example.gerard.afinal.PlaceAutocompleteAdapter;
...
public class PlaceSearch extends AppCompatDialog implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, View.OnClickListener {
    ...
    public PlaceSearch(Context context, Builder builder) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(context)
               ...
               // .addApi(Place.initialize(getApplicationContext(), "YOUR_API_KEY"))
    ...
    public static class Builder {
        ...
        public PlaceSearch build() {
            return new PlaceSearch(context, this);
        }
